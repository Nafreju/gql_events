...
PresenceTypeGQLModel = Annotated["PresenceTypeGQLModel", strawberryA.lazy("..GraphTypeDefinitionsOld")]
InvitationTypeGQLModel = Annotated["InvitationTypeGQLModel", strawberryA.lazy("..GraphTypeDefinitionsOld")]
...
class PresenceGQLModel:
    ...
    async def presence_type(self, info: strawberryA.types.Info) -> Optional["PresenceTypeGQLModel"]:
    ...
    async def invitation_type(self, info: strawberryA.types.Info) -> Optional["InvitationTypeGQLModel"]:
    ...
    async def event(self, info: strawberryA.types.Info) -> Optional["EventGQLModel"]:
